...
//string array of (students names) and (student numbers)  & (room names)
...
void populate(Library& lib){
    //fill up the Student pointer list and Room pointer list
    // add some Students
    for (int i = 0; i <5; ++i){
...
//forth
    ...
    if (lib.isFree(rooms[1],d1)){
        ...
        cout << red  << "Error** Its not free"<<def<<endl<<endl;
    }
